...
# The code below was generated by claude sonnet 4..
# yes I know, 'vibe code bad!'
# But I (at the time of writing) don't have a ton of scripting knowledge
# just ambition, and a passion to create something and learn along the way
...
readonly WINE_PATTERN="wine-.*-staging-tkg-amd64-wow64\.tar\.xz"
